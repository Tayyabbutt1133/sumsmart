  ...
  return (
    <footer className='h-'>
        ...
        >
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className='flex flex-wrap justify-center gap-4'>
              ...
              <Link
                className="flex items-center justify-center text-[#FF6719] transition hover:text-[#d95602]"
      ...
      <div className="relative -mt-16 w-full" aria-hidden="true">
        <div className="pointer-events-none lg:mt-[4vh] mt-[8vh] absolute left-1/2 -z-10 -translate-x-1/2 text-center xl:text-[250px] text-[18vw] font-bold leading-none before:bg-gradient-to-b before:from-gray-200 before:to-gray-100/30 before:to-80% before:bg-clip-text before:text-transparent before:content-['SumSmart'] after:absolute after:inset-0 after:bg-gray-300/70 after:bg-clip-text after:text-transparent after:mix-blend-darken after:content-['SumSmart'] after:[text-shadow:0_1px_0_white]"/>
        {/* Glow */}
